...
const GEAR_DATABASE = {
    ...
    kits: [
        ...
        { key: "aburrey_auditory_chip_kit", name: "Aburrey Auditory Chip", setKey: "aburrey_legacy", rarity: 4, mainStat: "Strength", mainValue: 23, secStat: "Will", secValue: 15, subStat: "DMG Bonus vs. Staggered %", subValue: 42, defValue: 15, icon: "assets/gear/aburrey_legacy_kit.png" },
        { key: "aburrey_flashlight_kit", name: "Aburrey Flashlight", setKey: "aburrey_legacy", rarity: 4, mainStat: "Intellect", mainValue: 23, secStat: "Strength", secValue: 15, subStat: "Ultimate Gain Efficiency %", subValue: 17.5, defValue: 15, icon: "assets/gear/aburrey_legacy_kit.png" },
        { key: "aburrey_sensor_chip_kit", name: "Aburrey Sensor Chip", setKey: "aburrey_legacy", rarity: 4, mainStat: "Will", mainValue: 23, secStat: "Agility", secValue: 15, subStat: "Battle Skill DMG Bonus %", subValue: 29.4, defValue: 15, icon: "assets/gear/aburrey_legacy_kit.png" },
        ...
        { key: "type_50_yinglung_knife_kit", name: "Type 50 Yinglung Knife", setKey: "type_50_yinglung", rarity: 5, mainStat: "Will", mainValue: 32, secStat: "Agility", secValue: 21, subStat: "Combo Skill DMG Bonus %", subValue: 41.4, defValue: 21, icon: "assets/gear/type_50_yinglung_kit.png" },
        { key: "mordvolt_resistant_wrench_kit", name: "Mordvolt Resistant Wrench", setKey: "mordvolt_resistant", rarity: 3, mainStat: "Will", mainValue: 21, secStat: null, secValue: null, subStat: "ATK Bonus %", subValue: 10.5, defValue: 10.799999999999999, icon: "assets/gear/mordvolt_resistant_kit.png" },
        ...
        { key: "armored_msgr_flashlight_kit", name: "Armored MSGR Flashlight", setKey: "armored_msgr", rarity: 3, mainStat: "Strength", mainValue: 21, secStat: null, secValue: null, subStat: "HP Bonus %", subValue: 21, defValue: 10.799999999999999, icon: "assets/gear/armored_msgr_kit.png" },
        ...
        { key: "lynx_aegis_injector_kit", name: "LYNX Aegis Injector", setKey: "lynx", rarity: 5, mainStat: "Will", mainValue: 41, secStat: null, secValue: null, subStat: "Treatment Effect %", subValue: 20.7, defValue: 21, icon: "assets/gear/lynx_kit.png" },
        ...
        { key: "mordvolt_insulation_wrench_kit", name: "Mordvolt Insulation Wrench", setKey: "mordvolt_insulation", rarity: 3, mainStat: "Intellect", mainValue: 21, secStat: null, secValue: null, subStat: "ATK Bonus %", subValue: 10.5, defValue: 10.799999999999999, icon: "assets/gear/mordvolt_insulation_kit.png" },
        ...
        { key: "Æthertech_analysis_band_kit", name: "Æthertech Analysis Band", setKey: "aethertech", rarity: 5, mainStat: "Strength", mainValue: 32, secStat: "Will", secValue: 21, subStat: "Physical DMG Bonus %", subValue: 23, defValue: 21, icon: "assets/gear/aethertech_kit.png" },
        { key: "Æthertech_stabilizer_kit", name: "Æthertech Stabilizer", setKey: "aethertech", rarity: 5, mainStat: "Agility", mainValue: 32, secStat: "Strength", secValue: 21, subStat: "Arts Intensity", subValue: 41.4, defValue: 21, icon: "assets/gear/aethertech_kit.png" },
        { key: "mi_security_armband_kit", name: "MI Security Armband", setKey: "mi_security", rarity: 5, mainStat: "Strength", mainValue: 32, secStat: "Will", secValue: 21, subStat: "Crit Rate %", subValue: 23, defValue: 21, icon: "assets/gear/mi_security_kit.png" },
        { key: "mi_security_scope_kit", name: "MI Security Scope", setKey: "mi_security", rarity: 5, mainStat: "Agility", mainValue: 32, secStat: "Strength", secValue: 21, subStat: "Battle Skill DMG Bonus %", subValue: 41.4, defValue: 21, icon: "assets/gear/mi_security_kit.png" },
        ...
        { key: "mi_security_push_knife_kit", name: "MI Security Push Knife", setKey: "mi_security", rarity: 5, mainStat: "Will", mainValue: 32, secStat: "Intellect", secValue: 21, subStat: "Crit Rate %", subValue: 23, defValue: 21, icon: "assets/gear/mi_security_kit.png" },
        { key: "catastrophe_gauze_cartridge_kit", name: "Catastrophe Gauze Cartridge", setKey: "catastrophe", rarity: 4, mainStat: "Strength", mainValue: 23, secStat: "Intellect", secValue: 15, subStat: "Ultimate DMG Bonus %", subValue: 36.8, defValue: 15, icon: "assets/gear/catastrophe_kit.png" },
        ...
        { key: "aic_ceramic_plate_kit", name: "AIC Ceramic Plate", setKey: "aic_light", rarity: 2, mainStat: "Will", mainValue: 16, secStat: null, secValue: null, subStat: "Battle Skill DMG Bonus %", subValue: 16.2, defValue: 8.4, icon: "assets/gear/aic_light_kit.png" },
        ...
        { key: "bonekrusha_mask_kit", name: "Bonekrusha Mask", setKey: "bonekrusha", rarity: 5, mainStat: "Agility", mainValue: 32, secStat: "Strength", secValue: 21, subStat: "DMG Bonus vs. Staggered %", subValue: 59.1, defValue: 21, icon: "assets/gear/bonekrusha_kit.png" },
        ...
        { key: "eternal_xiranite_auxiliary_arm_kit", name: "Eternal Xiranite Auxiliary Arm", setKey: "eternal_xiranite", rarity: 5, mainStat: "Will", mainValue: 32, secStat: "Intellect", secValue: 21, subStat: "Ultimate Gain Efficiency %", subValue: 24.6, defValue: 21, icon: "assets/gear/eternal_xiranite_kit.png" },
        ...
        { key: "roving_msgr_flashlight_kit", name: "Roving MSGR Flashlight", setKey: "roving_msgr", rarity: 3, mainStat: "Agility", mainValue: 21, secStat: null, secValue: null, subStat: "Combo Skill DMG Bonus %", subValue: 21, defValue: 10.799999999999999, icon: "assets/gear/roving_msgr_kit.png" },
        ...
        { key: "aic_alloy_plate_kit", name: "AIC Alloy Plate", setKey: "aic_heavy", rarity: 2, mainStat: "Agility", mainValue: 16, secStat: null, secValue: null, subStat: "Final DMG Reduction %", subValue: 7.5, defValue: 8.4, icon: "assets/gear/aic_heavy_kit.png" },
        ...
        { key: "hot_work_pyrometer_kit", name: "Hot Work Pyrometer", setKey: "hot_work", rarity: 5, mainStat: "Intellect", mainValue: 41, secStat: null, secValue: null, subStat: "Battle Skill DMG Bonus %", subValue: 41.4, defValue: 21, icon: "assets/gear/hot_work_kit.png" },
        { key: "hot_work_power_cartridge_kit", name: "Hot Work Power Cartridge", setKey: "hot_work", rarity: 5, mainStat: "Will", mainValue: 32, secStat: "Intellect", secValue: 21, subStat: "Arts Intensity", subValue: 41.4, defValue: 21, icon: "assets/gear/hot_work_kit.png" },
        ...
        { key: "frontiers_extra_o2_tube_kit", name: "Frontiers Extra O2 Tube", setKey: "frontiers", rarity: 5, mainStat: "Agility", mainValue: 32, secStat: "Intellect", secValue: 21, subStat: "Main Attribute %", subValue: 20.7, defValue: 21, icon: "assets/gear/frontiers_kit.png" },
        ...
        { key: "turbid_cutting_torch_kit", name: "Turbid Cutting Torch", setKey: "tide_surge", rarity: 5, mainStat: "Intellect", mainValue: 32, secStat: "Strength", secValue: 21, subStat: "Arts DMG Bonus %", subValue: 27.6, defValue: 21, icon: "assets/gear/tide_surge_kit.png" }
