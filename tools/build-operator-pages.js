...
function baseStyles() {
  return `<style>
    ...
    *{box-sizing:border-box}body{margin:0;min-height:100vh;font-family:Inter,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;color:var(--text);background:radial-gradient(circle at 18% 0%,rgba(160,170,169,.22),transparent 32rem),radial-gradient(circle at 82% 8%,rgba(248,245,70,.14),transparent 34rem),linear-gradient(135deg,#313739,#252c2e 52%,#181d1f)}body:before{content:"";position:fixed;inset:0;pointer-events:none;opacity:.15;background-image:linear-gradient(rgba(160,170,169,.18) 1px,transparent 1px),linear-gradient(90deg,rgba(160,170,169,.18) 1px,transparent 1px);background-size:34px 34px;mask-image:linear-gradient(to bottom,#000,transparent 75%)}a{color:inherit;text-decoration:none}.top{position:sticky;top:0;z-index:5;border-bottom:1px solid rgba(160,170,169,.20);background:rgba(37,44,46,.82);backdrop-filter:blur(14px)}.nav{width:min(1280px,calc(100% - 32px));height:66px;margin:0 auto;display:flex;align-items:center;gap:24px}.brand{display:flex;align-items:center;gap:12px;font-weight:950;font-size:1.08rem}.mark{display:grid;place-items:center;width:36px;height:36px;border-radius:8px;color:#313739;background:var(--yellow);box-shadow:0 0 24px rgba(248,245,70,.22)}.tool-name{color:var(--text);padding-left:20px;border-left:1px solid rgba(160,170,169,.25)}.nav-links{margin-left:auto;display:flex;align-items:center;gap:28px;color:var(--text);font-weight:800;font-size:.92rem}.nav-cta{color:#313739;background:var(--yellow);border-radius:10px;padding:12px 18px;box-shadow:0 14px 30px rgba(248,245,70,.16)}.page{width:min(1280px,calc(100% - 32px));margin:0 auto;padding:28px 0 64px}.breadcrumbs{display:flex;gap:10px;align-items:center;color:var(--muted);font-weight:700;font-size:.92rem;margin:0 0 28px}.breadcrumbs strong{color:var(--text)}.button{display:inline-flex;align-items:center;justify-content:center;min-height:50px;padding:0 20px;border-radius:10px;font-weight:950}.primary{color:#313739;background:var(--yellow);box-shadow:0 16px 34px rgba(248,245,70,.18)}.secondary{background:rgba(126,128,124,.18);border:1px solid rgba(160,170,169,.25)}.panel{border:1px solid var(--border);border-radius:12px;background:rgba(49,55,57,.84);box-shadow:var(--shadow);padding:24px}.panel h2{margin:0 0 18px;font-size:1.35rem}.panel h2 span{color:var(--silver)}footer{margin-top:30px;text-align:center;color:rgba(160,170,169,.82);font-size:.9rem}
    ...
    @media(min-width:761px){.operator-page .nav{width:min(900px,calc(100% - 32px));height:44px;gap:14px}.operator-page .brand{gap:8px;font-size:.78rem}.operator-page .mark{width:26px;height:26px;border-radius:6px}.operator-page .tool-name{padding-left:12px;font-size:.73rem}.operator-page .nav-links{gap:17px;font-size:.7rem}.operator-page .nav-cta{padding:8px 12px;border-radius:8px}.operator-page .page{width:min(900px,calc(100% - 32px));padding:15px 0 36px}.operator-page .breadcrumbs{gap:8px;margin-bottom:15px;font-size:.68rem}.operator-page .button{min-height:34px;padding:0 13px;border-radius:7px;font-size:.78rem}.operator-page .panel{padding:15px;border-radius:9px}.operator-page .panel h2{margin-bottom:11px;font-size:.95rem}.operator-page footer{margin-top:18px;font-size:.68rem}
    .operator-page .hero{grid-template-columns:265px minmax(0,1fr) 255px;gap:18px}.operator-page .portrait-card{min-height:270px;border-radius:9px}.operator-page .portrait-card:before{width:11px}.operator-page .portrait-card:after{left:22px;top:15px;font-size:.56rem}.operator-page .portrait{width:min(220px,82%);max-height:220px}.operator-page .barcode{left:19px;bottom:14px;font-size:.42rem;padding:6px 3px}.operator-page .hero-copy{padding:3px 0}.operator-page .eyebrow{margin-bottom:12px;font-size:.56rem;letter-spacing:.34em}.operator-page h1{font-size:clamp(2.5rem,4vw,3.5rem);line-height:.92}.operator-page .stars{margin-top:11px;font-size:1.28rem}.operator-page .subtitle{margin-top:14px;line-height:1.6;font-size:.76rem}.operator-page .actions{gap:8px;margin-top:18px}.operator-page .info-panel{padding:12px;border-radius:9px}.operator-page .info-grid{gap:5px}.operator-page .info-card{min-height:64px;padding:13px 10px 10px 41px;border-radius:7px}.operator-page .info-icon{left:11px;top:18px;width:22px;height:22px}.operator-page .text-icon{font-size:.9rem}.operator-page .info-label{font-size:.52rem}.operator-page .info-card strong{margin-top:5px;font-size:.78rem}.operator-page .rarity{padding-left:14px}.operator-page .rarity .star-line{margin-top:6px;font-size:1.02rem}.operator-page .meta-strip{margin-top:17px;border-radius:8px}.operator-page .meta-item{padding:15px 18px;grid-template-columns:26px 1fr;gap:9px}.operator-page .meta-icon{font-size:1.05rem}.operator-page .meta-label{font-size:.54rem}.operator-page .meta-value{margin-top:3px;font-size:.73rem}.operator-page .lower{gap:14px;margin-top:14px}.operator-page .stats-grid{gap:8px}.operator-page .stat{min-height:54px;padding:11px 9px 8px 37px}.operator-page .stat-icon{left:12px;top:19px;font-size:.9rem}.operator-page .stat-label{font-size:.54rem}.operator-page .stat strong{font-size:.92rem}.operator-page .attribute-title{margin:15px 0 9px;font-size:.88rem}.operator-page .highlight{margin-top:11px;padding:12px}.operator-page .skills-section,.operator-page .related-section{margin-top:14px}.operator-page .skills-grid{gap:9px}.operator-page .skill-card{padding:12px}}
    ...
    @media(min-width:761px) and (max-width:1120px){.operator-page .hero{grid-template-columns:1fr 1fr}}
  </style>`;
}
