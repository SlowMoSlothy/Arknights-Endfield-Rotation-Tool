...
function baseStyles() {
  return `<style>
    ...
    *{box-sizing:border-box}body{margin:0;min-height:100vh;font-family:Inter,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;color:var(--text);background:radial-gradient(circle at 18% 0%,rgba(160,170,169,.22),transparent 32rem),radial-gradient(circle at 82% 8%,rgba(248,245,70,.14),transparent 34rem),linear-gradient(135deg,#313739,#252c2e 52%,#181d1f)}body:before{content:"";position:fixed;inset:0;pointer-events:none;opacity:.15;background-image:linear-gradient(rgba(160,170,169,.18) 1px,transparent 1px),linear-gradient(90deg,rgba(160,170,169,.18) 1px,transparent 1px);background-size:34px 34px;mask-image:linear-gradient(to bottom,#000,transparent 75%)}a{color:inherit;text-decoration:none}.top{position:sticky;top:0;z-index:5;border-bottom:1px solid rgba(160,170,169,.20);background:rgba(37,44,46,.82);backdrop-filter:blur(14px)}.nav{width:min(1280px,calc(100% - 32px));height:66px;margin:0 auto;display:flex;align-items:center;gap:24px}.brand{display:flex;align-items:center;gap:12px;font-weight:950;font-size:1.08rem}.mark{display:grid;place-items:center;width:36px;height:36px;border-radius:8px;color:#313739;background:var(--yellow);box-shadow:0 0 24px rgba(248,245,70,.22)}.tool-name{color:var(--text);padding-left:20px;border-left:1px solid rgba(160,170,169,.25)}.nav-links{margin-left:auto;display:flex;align-items:center;gap:28px;color:var(--text);font-weight:800;font-size:.92rem}.nav-cta{color:#313739;background:var(--yellow);border-radius:10px;padding:12px 18px;box-shadow:0 14px 30px rgba(248,245,70,.16)}.page{width:min(1280px,calc(100% - 32px));margin:0 auto;padding:28px 0 64px}.breadcrumbs{display:flex;gap:10px;align-items:center;color:var(--muted);font-weight:700;font-size:.92rem;margin:0 0 28px}.breadcrumbs strong{color:var(--text)}.button{display:inline-flex;align-items:center;justify-content:center;min-height:50px;padding:0 20px;border-radius:10px;font-weight:950}.primary{color:#313739;background:var(--yellow);box-shadow:0 16px 34px rgba(248,245,70,.18)}.secondary{background:rgba(126,128,124,.18);border:1px solid rgba(160,170,169,.25)}.panel{border:1px solid var(--border);border-radius:12px;background:rgba(49,55,57,.84);box-shadow:var(--shadow);padding:24px}.panel h2{margin:0 0 18px;font-size:1.35rem}.panel h2 span{color:var(--silver)}footer{margin-top:30px;text-align:center;color:rgba(160,170,169,.82);font-size:.9rem}
    ...
    .operator-page .nav{width:min(1180px,calc(100% - 32px));height:58px;gap:18px}.operator-page .brand{gap:10px;font-size:1rem}.operator-page .mark{width:32px;height:32px}.operator-page .tool-name{padding-left:16px;font-size:.94rem}.operator-page .nav-links{gap:22px;font-size:.88rem}.operator-page .nav-cta{padding:10px 15px}.operator-page .page{width:min(1180px,calc(100% - 32px));padding:20px 0 48px}.operator-page .breadcrumbs{margin-bottom:20px;font-size:.86rem}.operator-page .button{min-height:44px;padding:0 17px;border-radius:9px}.operator-page .panel{padding:20px}.operator-page .panel h2{margin-bottom:14px;font-size:1.2rem}.operator-page footer{margin-top:24px;font-size:.84rem}
    .operator-page .hero{grid-template-columns:350px minmax(0,1fr) 340px;gap:24px}.operator-page .portrait-card{min-height:360px;border-radius:12px}.operator-page .portrait-card:before{width:14px}.operator-page .portrait-card:after{left:29px;top:20px;font-size:.72rem}.operator-page .portrait{width:min(285px,82%);max-height:285px}.operator-page .barcode{left:25px;bottom:18px;font-size:.52rem}.operator-page .hero-copy{padding:4px 0}.operator-page .eyebrow{margin-bottom:16px;font-size:.72rem;letter-spacing:.38em}.operator-page h1{font-size:clamp(3.1rem,5vw,4.7rem);line-height:.92}.operator-page .stars{margin-top:14px;font-size:1.65rem}.operator-page .subtitle{margin-top:18px;line-height:1.65;font-size:.96rem}.operator-page .actions{gap:10px;margin-top:24px}.operator-page .info-panel{padding:16px;border-radius:12px}.operator-page .info-card{min-height:86px;padding:17px 14px 14px 54px}.operator-page .info-icon{left:14px;top:24px;width:28px;height:28px}.operator-page .text-icon{font-size:1.15rem}.operator-page .info-label{font-size:.68rem}.operator-page .info-card strong{margin-top:7px;font-size:1rem}.operator-page .rarity{padding-left:18px}.operator-page .rarity .star-line{margin-top:8px;font-size:1.35rem}.operator-page .meta-strip{margin-top:22px}.operator-page .meta-item{padding:20px 24px;grid-template-columns:34px 1fr;gap:12px}.operator-page .meta-icon{font-size:1.4rem}.operator-page .meta-label{font-size:.7rem}.operator-page .meta-value{margin-top:4px;font-size:.94rem}.operator-page .lower{gap:18px;margin-top:18px}.operator-page .stats-grid{gap:10px}.operator-page .stat{min-height:70px;padding:14px 12px 10px 48px}.operator-page .stat-icon{left:16px;top:24px;font-size:1.15rem}.operator-page .stat-label{font-size:.7rem}.operator-page .stat strong{font-size:1.18rem}.operator-page .attribute-title{margin:20px 0 12px;font-size:1.12rem}.operator-page .highlight{margin-top:14px;padding:15px}.operator-page .skills-section,.operator-page .related-section{margin-top:18px}.operator-page .skills-grid{gap:12px}.operator-page .skill-card{padding:15px}
    ...
    @media(max-width:1120px){.operator-page .hero{grid-template-columns:1fr 1fr}}@media(max-width:760px){.operator-page .nav{height:auto}.operator-page .hero{grid-template-columns:1fr}.operator-page h1{font-size:3.2rem}}@media(max-width:520px){.operator-page .page,.operator-page .nav{width:min(100% - 20px,1180px)}.operator-page .portrait-card{min-height:300px}.operator-page .panel{padding:18px}}
  </style>`;
}
