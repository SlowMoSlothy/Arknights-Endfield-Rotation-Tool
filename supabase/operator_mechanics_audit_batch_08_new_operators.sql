...
(2802,28,2,'Jadecrushing Grid','Battle Skill','BS',null,100,'nature','assets/operators/avatars/Arcane.png','assets/operators/skills/arcane/jadecrushing-grid.png',
 ...
 '{
   ...
   "attributeVariants":[
     {"key":"intellect","label":"Array Arcana: INT","condition":{"leftStat":"intellect","comparison":"gte","rightStat":"will"},"actionOverride":{"icon":"assets/operators/skills/arcane/jadecrushing-grid-int.png","iconSmall":"assets/operators/skills/arcane/jadecrushing-grid-int.png","description":"Array Arcana: INT deals 500% ATK as Nature DMG and applies Nature Infliction.","damageMultiplier":500,"damageProfile":{"atkMultiplier":5.0}}},
     {"key":"will","label":"Array Arcana: WILL","condition":{"leftStat":"will","comparison":"gt","rightStat":"intellect"},"actionOverride":{"icon":"assets/operators/skills/arcane/jadecrushing-grid-will.png","iconSmall":"assets/operators/skills/arcane/jadecrushing-grid-will.png","description":"Array Arcana: WILL deals 300% ATK as Nature DMG, applies Nature Infliction, and pulls enemies toward the center.","damageMultiplier":300,"damageProfile":{"atkMultiplier":3.0},"debuffs":[{"id":"nature_infliction","name":"Nature Infliction","appliesEffect":"nature_infliction","persistsForCombo":true,"visible":true,"stackable":true,"stacksApplied":1,"maxStacks":4},{"id":"pull","name":"Pull","appliesEffect":"pull","persistsForCombo":false,"visible":true}]}}
   ]
 }'::jsonb),
(2803,28,3,'Yinglung Stance IV','Combo Skill','CS',13,0,'nature','assets/operators/avatars/Arcane.png','assets/operators/skills/arcane/yinglung-stance-iv.png',
 ...
 '{
   ...
   "attributeVariants":[
     {"key":"intellect","label":"Array Arcana: INT","condition":{"leftStat":"intellect","comparison":"gte","rightStat":"will"},"actionOverride":{"icon":"assets/operators/skills/arcane/yinglung-stance-iv-int.png","iconSmall":"assets/operators/skills/arcane/yinglung-stance-iv-int.png","description":"INT form: 13s cooldown. Requires Nature Infliction or 2 stacks of another Arts Infliction; applies 4s Imprisonment and 4% Arts Susceptibility.","cooldown":13}},
     {"key":"will","label":"Array Arcana: WILL","condition":{"leftStat":"will","comparison":"gt","rightStat":"intellect"},"actionOverride":{"icon":"assets/operators/skills/arcane/yinglung-stance-iv-will.png","iconSmall":"assets/operators/skills/arcane/yinglung-stance-iv-will.png","description":"WILL form: 19s cooldown. Requires 1 stack of any Arts Infliction; applies 6s Imprisonment and 12% Arts Susceptibility.","cooldown":19,"comboTriggerMode":"any","comboTriggers":[{"effect":"nature_infliction","minStacks":1},{"effect":"heat_infliction","minStacks":1},{"effect":"cryo_infliction","minStacks":1},{"effect":"electric_infliction","minStacks":1}],"debuffs":[{"id":"imprisonment","name":"Imprisonment","appliesEffect":"imprisonment","durationSeconds":6,"persistsForCombo":false,"visible":true},{"id":"arts_susceptibility","name":"Arts Susceptibility","appliesEffect":"arts_susceptibility","valuePercent":12,"durationSeconds":6,"persistsForCombo":true,"visible":true}]}}
   ]
 }'::jsonb),
(2804,28,4,'Gloompurge','Ultimate','Ult',20,100,'nature','assets/operators/avatars/Arcane.png','assets/operators/skills/arcane/gloompurge.png',
 ...
 '{
   ...
   "attributeVariants":[
     {"key":"intellect","label":"Array Arcana: INT","condition":{"leftStat":"intellect","comparison":"gte","rightStat":"will"},"actionOverride":{"icon":"assets/operators/skills/arcane/gloompurge-int.png","iconSmall":"assets/operators/skills/arcane/gloompurge-int.png","description":"INT form: the second cast deals 1440% Nature DMG, applies Corrosion for 15s, and grants the team 24% Arts DMG.","secondCast":{"damageProfile":{"atkMultiplier":14.4,"element":"nature","verified":true},"debuffs":[{"id":"corrosion","name":"Corrosion","appliesEffect":"corrosion","durationSeconds":15,"visible":true,"persistsForCombo":true}],"buffs":[{"id":"gloompurge_arts_amp","name":"Gloompurge Arts Amp","appliesEffect":"gloompurge_arts_amp","target":"team","artsDamagePercent":24,"visible":true}]}}},
     {"key":"will","label":"Array Arcana: WILL","condition":{"leftStat":"will","comparison":"gt","rightStat":"intellect"},"actionOverride":{"icon":"assets/operators/skills/arcane/gloompurge-will.png","iconSmall":"assets/operators/skills/arcane/gloompurge-will.png","description":"WILL form: the second cast deals 360% Nature DMG, duplicates the current Arts Infliction, and applies 12.8% Nature and Cryo Susceptibility for 10s.","secondCast":{"damageProfile":{"atkMultiplier":3.6,"element":"nature","verified":true},"duplicateCurrentArtsInfliction":true,"debuffs":[{"id":"nature_susceptibility","name":"Nature Susceptibility","appliesEffect":"nature_susceptibility","valuePercent":12.8,"durationSeconds":10,"visible":true,"persistsForCombo":true},{"id":"cryo_susceptibility","name":"Cryo Susceptibility","appliesEffect":"cryo_susceptibility","valuePercent":12.8,"durationSeconds":10,"visible":true,"persistsForCombo":true}]}}}
   ]
 }'::jsonb),
...
(3001,30,1,'Starry Heart Throb','Final Strike','FS',null,null,'electric','assets/operators/avatars/Liino.png','assets/operators/skills/liino/starry-heart-throb.png',
...
(3002,30,2,'Dazzling Focus','Battle Skill','BS',null,null,'electric','assets/operators/avatars/Liino.png','assets/operators/skills/liino/dazzling-focus.png',
...
(3003,30,3,'Delightful Harmonics','Combo Skill','CS',null,0,'electric','assets/operators/avatars/Liino.png','assets/operators/skills/liino/delightful-harmonics.png',
...
(3004,30,4,'Dawnstar Concerto','Ultimate','Ult',null,null,'electric','assets/operators/avatars/Liino.png','assets/operators/skills/liino/dawnstar-concerto.png',
