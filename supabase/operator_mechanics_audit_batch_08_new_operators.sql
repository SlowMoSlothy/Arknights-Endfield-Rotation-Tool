...
(2802,28,2,'Jadecrushing Grid','Battle Skill','BS',null,100,'nature','assets/operators/avatars/Arcane.png','assets/operators/skills/arcane/jadecrushing-grid.png',
 ...
 '{
   ...
   "attributeVariants":[
     {"key":"intellect","label":"Array Arcana: INT","condition":{"leftStat":"intellect","comparison":"gte","rightStat":"will"},"actionOverride":{"iconSmall":"assets/operators/skills/arcane/jadecrushing-grid-int.png","description":"Array Arcana: INT deals 500% ATK as Nature DMG and applies Nature Infliction.","damageMultiplier":500,"damageProfile":{"atkMultiplier":5.0}}},
     {"key":"will","label":"Array Arcana: WILL","condition":{"leftStat":"will","comparison":"gt","rightStat":"intellect"},"actionOverride":{"iconSmall":"assets/operators/skills/arcane/jadecrushing-grid-will.png","description":"Array Arcana: WILL deals 300% ATK as Nature DMG, applies Nature Infliction, and pulls enemies toward the center.","damageMultiplier":300,"damageProfile":{"atkMultiplier":3.0},"debuffs":[{"id":"nature_infliction","name":"Nature Infliction","appliesEffect":"nature_infliction","persistsForCombo":true,"visible":true,"stackable":true,"stacksApplied":1,"maxStacks":4},{"id":"pull","name":"Pull","appliesEffect":"pull","persistsForCombo":false,"visible":true}]}}
   ]
 }'::jsonb),
(2803,28,3,'Yinglung Stance IV','Combo Skill','CS',13,0,'nature','assets/operators/avatars/Arcane.png','assets/operators/skills/arcane/yinglung-stance-iv.png',
 ...
 '{
   ...
   "attributeVariants":[
     {"key":"intellect","label":"Array Arcana: INT","condition":{"leftStat":"intellect","comparison":"gte","rightStat":"will"},"actionOverride":{"iconSmall":"assets/operators/skills/arcane/yinglung-stance-iv-int.png","description":"INT form: 13s cooldown. Requires Nature Infliction or 2 stacks of another Arts Infliction; applies 4s Imprisonment and 4% Arts Susceptibility.","cooldown":13}},
     {"key":"will","label":"Array Arcana: WILL","condition":{"leftStat":"will","comparison":"gt","rightStat":"intellect"},"actionOverride":{"iconSmall":"assets/operators/skills/arcane/yinglung-stance-iv-will.png","description":"WILL form: 19s cooldown. Requires 1 stack of any Arts Infliction; applies 6s Imprisonment and 12% Arts Susceptibility.","cooldown":19,"comboTriggerMode":"any","comboTriggers":[{"effect":"nature_infliction","minStacks":1},{"effect":"heat_infliction","minStacks":1},{"effect":"cryo_infliction","minStacks":1},{"effect":"electric_infliction","minStacks":1}],"debuffs":[{"id":"imprisonment","name":"Imprisonment","appliesEffect":"imprisonment","durationSeconds":6,"persistsForCombo":false,"visible":true},{"id":"arts_susceptibility","name":"Arts Susceptibility","appliesEffect":"arts_susceptibility","valuePercent":12,"durationSeconds":6,"persistsForCombo":true,"visible":true}]}}
   ]
 }'::jsonb),
