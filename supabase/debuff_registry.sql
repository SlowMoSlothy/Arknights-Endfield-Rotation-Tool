...
insert into public.debuff_registry (
    ...
    ('arts_susceptibility', 'arknights_endfield', 'Arts Susceptibility', null, 'assets/ui/debuffs/arts_susceptibility', false, 4, 'svg', 100, '{"name":"Arts Susceptibility","iconBase":"assets/ui/debuffs/arts_susceptibility","stackable":false,"maxStacks":4,"extension":"svg"}'::jsonb),
    ('heat_infliction', 'arknights_endfield', 'Heat Infliction', null, 'assets/ui/debuffs/heat_infliction', true, 4, 'png', 110, '{"name":"Heat Infliction","iconBase":"assets/ui/debuffs/heat_infliction","stackable":true,"maxStacks":4,"extension":"png"}'::jsonb),
    ('heat_followup', 'arknights_endfield', 'Heat Follow-Up', null, 'assets/ui/debuffs/heat_followup', false, 0, 'png', 120, '{"name":"Heat Follow-Up","iconBase":"assets/ui/debuffs/heat_followup","stackable":false,"maxStacks":0,"extension":"png"}'::jsonb),
    ('cryo_infliction', 'arknights_endfield', 'Cryo Infliction', null, 'assets/ui/debuffs/cryo_infliction', true, 4, 'png', 130, '{"name":"Cryo Infliction","iconBase":"assets/ui/debuffs/cryo_infliction","stackable":true,"maxStacks":4,"extension":"png"}'::jsonb),
    ('cryo_susceptibility', 'arknights_endfield', 'Cryo Susceptibility', null, 'assets/ui/debuffs/cryo_susceptibility', false, 0, 'png', 140, '{"name":"Cryo Susceptibility","iconBase":"assets/ui/debuffs/cryo_susceptibility","stackable":false,"maxStacks":0,"extension":"png"}'::jsonb),
    ('physical_susceptibility', 'arknights_endfield', 'Physical Susceptibility', 'assets/ui/debuffs/elements/physical.webp', null, false, 0, 'png', 150, '{"name":"Physical Susceptibility","icon":"assets/ui/debuffs/elements/physical.webp","stackable":false,"maxStacks":0,"extension":"png"}'::jsonb),
