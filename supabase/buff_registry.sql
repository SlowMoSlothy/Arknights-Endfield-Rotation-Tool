...
insert into public.buff_registry (
    ...
    ('hypothermic_perfusion', 'arknights_endfield', 'Hypothermic Perfusion', null, 'assets/operators/skills/lastrite/bs_small', false, 0, 'png', 'final_strike', 1, null, 100, '{"name":"Hypothermic Perfusion","iconBase":"assets/operators/skills/lastrite/bs_small","stackable":false,"maxStacks":0,"extension":"png","consumeOnSkillType":"final_strike","consumeStacks":1,"onConsume":{"replacesSkillDamage":true,"id":"last_rite_mirage","name":"Last Rite''s Mirage","operatorId":20,"type":"Triggered Effect","shortType":"PROC","elementType":"cryo","icon":"assets/operators/avatars/Last_Rite.png","iconSmall":"assets/operators/skills/lastrite/bs_small.png","damageProfile":{"atkMultiplier":1.42,"flatDamage":0,"hitCount":1,"element":"cryo","verified":true,"sourceUrl":"https://endfield.wiki.gg/wiki/Last_Rite","canCrit":true},"debuffs":[{"id":"cryo_infliction","name":"Cryo Infliction","appliesEffect":"cryo_infliction","persistsForCombo":true,"visible":true,"stackable":true,"stacksApplied":1,"maxStacks":4}]}}'::jsonb),
